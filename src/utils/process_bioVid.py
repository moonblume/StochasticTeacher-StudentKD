...
def _parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default=r'path to raw data BioVid')
    parser.add_argument('--output_dir', type=str, default=r'output path to save npz files')
